...
and launch **shiny-server** on Terminal of an RStudio Server in the container, and you can access the nbinomPlot app at [http://example.com:3838/nbinomPlot](http://example.com:3838/nbinomPlot). Note that you have to replace the URL with an actual server.
...
You can run a code formatter, a static code analyzer, and count lines of code.

```{r analyze, echo = TRUE, eval = FALSE}
library(styler)
library(lintr)
styler::style_dir()
lintr::lint_dir("R")
