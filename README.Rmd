...
and launch **shiny-server** in the container, and you can access the nbinomPlot app at [http://example.com:3838/nbinomPlot](http://example.com:3838/nbinomPlot). Note that you have to replace the URL with an actual server.
