...
test_that("Download", {
  ...
  compare_downloaded_file <- function(df_actual, expected) {
    tolerance <- 1e-7
  ...
  set_and_download <- function(size, prob, quantile, expected) {
    ...
    compare_downloaded_file(df_actual = df_actual, expected = expected)
  }
  ...
  compare_downloaded_file(df_actual = df_actual, expected = expected_first)
  ...
  df_actual <- download_without_dialog(app = app, id = NS("nbplot", "download"))
  compare_downloaded_file(df_actual = df_actual, expected = expected_second)
